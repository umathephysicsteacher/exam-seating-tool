...
# streamlit_exam_tool_download_all.py
# Streamlit app — final + "Download All Files to Downloads" feature
...
# ---------------- UI ----------------
st.set_page_config(page_title="ExamSeatingTool — Download All", layout="wide")
st.title("Exam Seating Tool — Download All (one-click save to Downloads)")
...
if st.session_state.get('outputs') and st.session_state.get('pdfs'):
    ...
    if st.button("📥 Download All Files to Downloads"):
